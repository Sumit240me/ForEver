...
const Login = ({ setToken }) => {
  ...
  const onSubmitHandler = async (e) => {
    try {
      // stops the reloadtion of page after submitting the form
      e.preventDefault()
      const response = await axios.post(backendUrl + '/api/user/admin', { email, password })
      // along with the api we are sending the email and password that will be added into the request body
