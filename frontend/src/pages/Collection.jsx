...
const Collection = () => {
  ...
  const toggleCategory = (e) => {
    //agar hoga tho hat jaeega or agar nahi hoga tho add ho jaeega
    // set category ke andar ek filter add hsi
  ...
  return (
    <div className='flex flex-col sm:flex-row gap-10 sm:gap-10 pt-10'>
      ...
      <div className='w-1/4'>
        <div className='sticky top-30'>
          <div className='min-w-60'>
            ...
            {/* we will add two filter 1 Category Filter */}
            ...
            <div className={`border border-gray-300 pl-5 py-3 my-5 ${showFilter ? '' : 'hidden'} sm:block`}>
              <p className='mb-3 text-sm font-medium'>TYE</p>
              <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
                <p className='flex gap-2'>
